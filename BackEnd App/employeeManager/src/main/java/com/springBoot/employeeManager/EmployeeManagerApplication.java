...
public class EmployeeManagerApplication {
	...
	public CorsFilter corsFilter() {
		...
		UrlBasedCorsConfigurationSource urlBasedCorsConfiguartionSource = new UrlBasedCorsConfigurationSource();
		urlBasedCorsConfiguartionSource.registerCorsConfiguration("/**", corsConfiguration);
		return new CorsFilter(urlBasedCorsConfiguartionSource);
	}
